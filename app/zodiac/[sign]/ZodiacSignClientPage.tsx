...
const ZodiacSignClientPage = ({ sign }: { sign: string }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getZodiacSign(sign)
        setZodiacData(data)
      } catch (error) {
    ...
    return (
      <div className="min-h-screen py-20 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-purple-200 mb-8">The zodiac sign you're looking for doesn't exist.</p>
          <Link
            href="/"
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          <motion.div {...slideUp} className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-gradient-to-br from-purple-800 to-indigo-800 p-8 rounded-2xl border border-purple-500">
              ...
              <p className="text-purple-200 text-lg leading-relaxed mb-6">{zodiacData.personality}</p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold text-white mb-3">Strengths</h3>
                  <ul className="space-y-2">
                    {zodiacData.strengths.map((strength, index) => (
                      <li key={index} className="text-green-300 flex items-center gap-2">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {zodiacData.weaknesses.map((weakness, index) => (
                      <li key={index} className="text-orange-300 flex items-center gap-2">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-pink-800 to-red-800 p-6 rounded-xl border border-pink-500">
                ...
                <p className="text-pink-200 text-sm leading-relaxed">{zodiacData.love}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-800 to-emerald-800 p-6 rounded-xl border border-green-500">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Career & Money</h3>
                <p className="text-green-200 text-sm leading-relaxed">{zodiacData.career}</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-800 to-cyan-800 p-6 rounded-xl border border-blue-500">
                ...
                <p className="text-blue-200 text-sm leading-relaxed">{zodiacData.health}</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-800 to-pink-800 p-8 rounded-2xl border border-purple-500">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-xl font-bold text-green-400 mb-4">Most Compatible With</h3>
                ...
                <div>
                  <h3 className="text-xl font-bold text-red-400 mb-4">Challenging Matches</h3>
                  <div className="flex flex-wrap gap-3">
          ...
          <motion.div {...slideUp} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-indigo-800 to-purple-800 p-6 rounded-2xl border border-indigo-500">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-semibold">{zodiacData.element}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-300">Quality:</span>
                  <span className="text-white font-semibold">{zodiacData.quality}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-300">Ruling Planet:</span>
                  <span className="text-white font-semibold">{zodiacData.rulingPlanet}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-300">Lucky Color:</span>
                  <span className="text-white font-semibold">{zodiacData.luckyColor}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-300">Lucky Number:</span>
                  <span className="text-white font-semibold">{zodiacData.luckyNumber}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-800 to-orange-800 p-6 rounded-2xl border border-yellow-500">
              <h3 className="text-xl font-bold text-white mb-4">Get Personal Insights</h3>
              <p className="text-yellow-200 mb-6 text-sm">
                Discover what the stars have planned specifically for you with a personalized reading.
              </p>
              <AffiliateButton
            ...
            <div className="bg-gradient-to-br from-pink-800 to-purple-800 p-6 rounded-2xl border border-pink-500">
              <h3 className="text-xl font-bold text-white mb-4">Love Guidance</h3>
              <p className="text-pink-200 mb-6 text-sm">
                Get specific advice about your romantic life and relationships from expert love psychics.
              </p>
              <AffiliateButton
            ...
            <div className="bg-gradient-to-br from-green-800 to-blue-800 p-6 rounded-2xl border border-green-500">
              <h3 className="text-xl font-bold text-white mb-4">Career Insights</h3>
              <p className="text-green-200 mb-6 text-sm">
                Unlock your professional potential with guidance tailored to your zodiac sign.
              </p>
              <AffiliateButton
                text="Career Reading"
        ...
        <motion.div {...fadeIn} className="text-center">
          <div className="bg-gradient-to-r from-purple-800 to-pink-800 p-8 rounded-2xl border border-purple-500">
            ...
            <p className="text-purple-200 mb-8 max-w-2xl mx-auto">
              While knowing your sun sign is great, your complete birth chart reveals so much more about your
